...
const Topbar = () => {
    ...
    return createPortal(
        <>
            <nav className="hidden sm:flex justify-self-center text-xl font-lato text-sbeige p-4 space-x-8">
                <a href="/" className="hover:text-sbeige/50 transition duration-150">
                    Home
                </a>
                <a href="/locations" className="hover:text-sbeige/50 transition duration-150">
                    Locations
                </a>
            ...
            <div className="sm:hidden">
                <button onClick={() => setShowSidebar(!showSidebar)}><FontAwesomeIcon icon={faBars} className="text-sbeige size-8 p-4" /></button>
