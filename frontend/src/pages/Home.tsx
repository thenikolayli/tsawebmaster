...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-sbeige">
            <Sidebar/>
            <img alt="Food Gif" className="w-full top-0" src={imageSource} />
            <div className="py-4">
                <h1 className="text-4xl text-center font-playfair">We are a vegan restaurant</h1>
                <InstagramEmbed className="w-1/4 py-6 flex justify-self-center" url={"https://www.instagram.com/p/DB6C5z8JCUm/?hl=en&img_index=1"} />
            </div>
        </div>
    )
}
